...
class LoginController extends GetxController {
  ...
  List<String> locations = ['วัดนอน หมู่1 ซอย 1', 'วัดซับ หมู่2', 'User2'];
  ...
  final RxString userlocations = 'บางคนแค บางคนไม่แค'.obs;
  ...
  void fetchLogin() {
    ...
    if (userIndex != -1 && passwords[userIndex] == inputPassword) {
      ...
      userlocations.value = locations[userIndex];
